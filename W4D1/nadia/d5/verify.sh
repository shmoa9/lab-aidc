...
ubuntu@aidc-t16:~/aidc/nadia/d5$ bash verify.sh https://t16.aidc.nadir.sh c74e45477af0c7da8073a10ee2980ddc
note: no in-cluster Prometheus visible from here (running off-cluster?); metrics check skipped
outside-in posture verified for https://t16.aidc.nadir.sh serving Qwen/Qwen2.5-1.5B-Instruct-AWQ
GREEN CHECK: PASS
